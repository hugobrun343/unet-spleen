#!/usr/bin/env python3
"""
Training script using balanced dataset
- Uses balanced_dataset.json for training
- Proper train/val splits
- Clean and efficient training
"""
...
class BalancedTrainer:
    def __init__(self, model, train_loader, val_loader, device, config):
        ...
        # Tensorboard
        self.writer = SummaryWriter('runs/training_main')
        
        # Log file
        self.log_file = '/teamspace/studios/this_studio/spleen/logs/training_main.log'
        # Clear previous log
    ...
    def train_epoch(self, epoch):
        ...
        for batch_idx, (images, labels) in enumerate(self.train_loader):
            ...
            # Print progress
            if batch_idx % 10 == 0:
                self.log_message(f'Epoch {epoch}, Batch {batch_idx}/{len(self.train_loader)}, '
